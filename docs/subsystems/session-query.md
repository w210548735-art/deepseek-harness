...
<a id="ctxsessioncollaboration--sessioncollaborationruntime"></a>

### `ctx.sessionCollaboration` — `SessionCollaborationRuntime`
...
Source: [`packages/session-query/session-collaboration/src/index.ts:119`](../../packages/session-query/session-collaboration/src/index.ts)
