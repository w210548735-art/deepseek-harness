...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  sessionCollaboration: 'session-query.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  SessionCollaborationRequest: 'session collaboration request contract is owned by packages/session-query/session-collaboration/README.md',
  SessionCollaborationResult: 'session collaboration result contract is owned by packages/session-query/session-collaboration/README.md',
